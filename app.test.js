...
describe(`HTTP request`, ()=>{
    it(`Should return a payload with the following: { message: "I wish we had some information to give you ☹️" } when a get request is sent to '/' root`,
     async () => {
    ...
    it(`Should send a get request to "/users", receive a "200" response code and an object with the following layout:{ success: true, payload: expect.arrayContaining(ExpectedObject) }`,
     async () => {
